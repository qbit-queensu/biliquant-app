...
function ContactUs() {
  ...
  const validateForm = () => {
    ...
    if (!formData.name.trim()) {
      ...
      newErrors.name = t("contactPage.nameShort");
    }
        ...
        <div>
          <section className={styles.heroSection}>
            <div className={styles.heroContent}>
              <h1 className={styles.heroTitle}>{t("contactPage.title")}</h1>
              <p className={styles.heroSubtitle}>{t("contactPage.subtitle")}</p>
            </div>
            <a href="mailto:qbit@engsoc.queensu.ca" className={styles.ctaButton}>
          ...
          <section className={styles.socialSection}>
            ...
            >
              <div className={styles.socialIcon}>
                <svg className={styles.socialSvgIcon} fill="currentColor" viewBox="0 0 24 24">
            ...
            <form onSubmit={handleSubmit}>
              <div className={styles.formGrid}>
                <label className={styles.formLabel}>
                  <p className={styles.labelText}>{t("contactPage.fullName")}</p>
                  <input
                    type="text"
                    name="name"
                    value={formData.name}
                ...
                <label className={styles.formLabel}>
                  <p className={styles.labelText}>{t("contactPage.email")}</p>
                  <input
                    type="email"
                    name="email"
              ...
              <label className={styles.formLabel}>
                <p className={styles.labelText}>{t("contactPage.message")}</p>
                <textarea
                  name="message"
              ...
              {submitStatus === "success" && (
                <div className={styles.successMessage}>{t("contactPage.success")}</div>
              )}
              {submitStatus === "error" && (
                <div className={styles.errorMessage}>{t("contactPage.error")}</div>
              )}
            </form>
          </section>
        </div>
